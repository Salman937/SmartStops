                        ...
                        @endif
                            ...
                            {{ method_field('PUT') }}
                                ...
                                <div class="form-group {{ $errors->has('waypoint_name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Way-Point Name" value="{{ $category->waypoint_name }}" name="waypoint_name">
                                ...
                                <div class="form-group {{ $errors->has('category_name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="Enter Category Name" value="{{ $category->category_name }}" name="category_name">
